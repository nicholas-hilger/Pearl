...
add_perk(perk.cutpurse, "Cutpurse", "Chance to gain money on hit.", "Your looting skills have progressed to the point where you now have a chance to steal cash monies from an enemy on hit.#...even if they shouldn't conceivably have money on them.", "cutpurse")
add_perk(perk.raimifications, "Raimifications", "Enemies may die in groovy bloodsplosion.", "This run is now directed by Raimi himself. Enemies have a chance to emit a perplexingly large bloodsplosion when they die.##Oh, you deal 10% more damage overall as well.", "raimifications")
add_perk(perk.winging_it, "Winging It", "Less chance to fumble with weapons.", "The confidence from admitting your strategy means that you will be less likely to fumble when using a weapon you don't have the stats for.", "winging_it")
